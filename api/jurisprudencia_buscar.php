...
// IN NATURAL LANGUAGE MODE: MySQL decide solas cuáles palabras son
// relevantes de la pregunta completa (no hace falta que el usuario escriba
// palabras clave sueltas). :q se manda dos veces (SELECT + WHERE) porque
// PDO no deja reusar un named placeholder dos veces en modo no emulado.
$stmt = $pdo->prepare(
...
$stmt->execute([':q1' => $pregunta, ':q2' => $pregunta]);
